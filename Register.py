# Form implementation generated from reading ui file 'D:\TMĐT\Programming Technique\ProTech\FinalProject\ui\Register\Register.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(0, 0, 381, 621))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("../images/blur_thor.png"))
        self.label.setScaledContents(True)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(190, 0, 791, 621))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("../images/img_bg4.jpg"))
        self.label_2.setScaledContents(True)
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(parent=self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(0, 0, 381, 611))
        self.label_3.setText("")
        self.label_3.setPixmap(QtGui.QPixmap("../images/thor.png"))
        self.label_3.setScaledContents(True)
        self.label_3.setObjectName("label_3")
        self.groupBox = QtWidgets.QGroupBox(parent=self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(390, 100, 531, 311))
        font = QtGui.QFont()
...
"")
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(390, 420, 261, 81))
        font = QtGui.QFont()
        font.setFamily("UTM Bebas")
        font.setPointSize(14)
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(660, 420, 261, 80))
        font = QtGui.QFont()
        font.setFamily("UTM Bebas")
        font.setPointSize(14)
...
"")
        ...
        self.checkBoxTSandPP = QtWidgets.QCheckBox(parent=self.centralwidget)
        self.checkBoxTSandPP.setGeometry(QtCore.QRect(400, 510, 501, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.checkBoxTSandPP.setFont(font)
        self.checkBoxTSandPP.setStyleSheet("color:rgb(255, 255, 255)")
        self.checkBoxTSandPP.setObjectName("checkBoxTSandPP")
        self.pushButtonRegister = QtWidgets.QPushButton(parent=self.centralwidget)
        self.pushButtonRegister.setGeometry(QtCore.QRect(600, 550, 121, 41))
        font = QtGui.QFont()
        font.setFamily("UTM Bebas")
        font.setPointSize(14)
        font.setBold(False)
...
"background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgba(0, 0, 0, 255), stop:0.965174 rgba(0, 0, 139, 255));")
        ...
        self.pushButtonReturn.setGeometry(QtCore.QRect(40, 550, 111, 41))
        self.pushButtonReturn.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: qlineargradient(spread:pad, x1:0, y1:1, x2:0, y2:0, stop:0 rgba(0, 0, 0, 255), stop:0.965174 rgba(0, 0, 139, 255));")
        self.pushButtonReturn.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../images/icon_return.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.label_10.setGeometry(QtCore.QRect(20, 0, 131, 51))
        self.label_10.setText("")
        self.label_10.setPixmap(QtGui.QPixmap("../images/logo_2.png"))
        self.label_10.setScaledContents(True)
        self.label_10.setObjectName("label_10")
        self.horizontalLayoutWidget = QtWidgets.QWidget(parent=self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(390, 39, 531, 61))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBoxTSandPP.setText(_translate("MainWindow", "I\'ve read and agree with Terms of Service and our Privacy Policy"))
        self.pushButtonRegister.setText(_translate("MainWindow", "REGISTER"))
        self.label_4.setText(_translate("MainWindow", "REGISTER HERE"))
